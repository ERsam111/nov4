          ...
          <TableHeader>
            <TableRow className="border-b">
              {columns.map((col) => (
                <TableHead 
                  key={col.key}
                  className="border-r p-0 h-auto bg-muted/50"
                >
                  <div className="space-y-0">
                    <div className="font-semibold px-4 py-3 border-b">{col.label}</div>
              ...
              <TableHead className="w-24 border-r p-0 h-auto bg-muted/50">
                <div className="font-semibold px-4 py-3">Actions</div>
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
